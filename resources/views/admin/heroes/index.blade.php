...
@section('content')
    ...
    <div class="row">
        <a class="btn btn-primary mt-3 mb-3" href="{{ route('heroes.create') }}">Crear nuevo heroe</a>
    </div>
    <div class="row">
            ...
            <tbody>
                @foreach($heroes as $hero)
                    <tr>
                        ...
                        <div class="row">
                                <div class="col-4">
                                    <a href="{{ route('heroes.edit', ['id' => $hero->id]) }}" class="btn btn-warning text-white mr-5">Modificar</a>
                                </div>
                                <div class="col-4">
